//
//  DeleteFavoriteGameRepository.swift
//
//
...
public struct DeleteGameRepository<
  ...
  Transformer.Domain == GameModel
{
    ...
    public func execute(request: GameModel?) -> AnyPublisher<Bool, Error> {
        ...
        return localDataSource.delete(entities: mapper.transformDomainToEntity(domain: gameModel))
            .eraseToAnyPublisher()
    }
}
